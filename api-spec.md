...
plus any number of properties. The core [STAC Item spec](https://github.com/radiantearth/stac-spec/tree/master/item-spec/README.md) 
...
the data contained. [STAC collections](https://github.com/radiantearth/stac-spec/tree/master/collection-spec/README.md) contain this same 
...
[STAC Items](https://github.com/radiantearth/stac-spec/tree/master/item-spec/README.md) are analogous to OAFeat Features, are in GeoJSON, and are returned from the 
...
| Endpoint  | Returns                                                        | Description |
| --------  | -------------------------------------------------------------- | ----------- |
| `/`       | [Catalog](https://github.com/radiantearth/stac-spec/tree/master/catalog-spec/catalog-spec.md)            | Extends `/` from OAFeat to return a full STAC catalog. |
